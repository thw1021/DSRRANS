...
class ControlTask(HierarchicalTask):
    ...
    def __init__(self, function_set, env, action_spec, algorithm=None,
                 ...
                 multiobject=False, decision_tree_threshold_set=None, seed=32):
        """
        Parameters
        ----------
        ...
        if multiobject and n_actions == 1:
            self.lg.warning("Setting multiobject=True has no effect for \
        ...
        if not multiobject:
            ...
            self.lg.warning("multiobject=True; action_spec will be ignored.")
