...
class GPController:
    ...
    def verbose_print(self, timer, programs):
        ...
        if self.verbose:
            self.lg.logging()
            self.lg.logging("--------------------------------------------------")
            self.lg.logging("GP Time: {:.6}".format(timer))
            self.lg.logging()
            self.lg.logging("Unique expressions evaluated: {}".format(len(Program.cache)))
            self.lg.logging("Total expression evaluations: {}".format(self.total_nevals))
            self.lg.logging("--------------------------------------------------")
            self.lg.logging()
            self.lg.logging("GP -> best program this epoch:")
            self.lg.logging()
            self.lg.logging(programs[0].print_stats())
            self.lg.logging()
            self.lg.logging("--------------------------------------------------")
            self.lg.logging()
