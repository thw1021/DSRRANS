...
class Controller(object):
    ...
    def __init__(self, sess, prior, state_manager, debug=0, summary=False,
        ...
        if prior_max_length is None:
            ...
            self.lg.warning("Maximum length not constrained. Sequences will "
            ...
            self.lg.warning("max_length ({}) will be overridden by value from "
        ...
        if debug >= 1:
            ...
            for variable in tf.trainable_variables():
                ...
                self.lg.logging("Variable:    ", variable.name)
                self.lg.logging("  Shape:     ", shape)
                self.lg.logging("  Parameters:", n_parameters)
            self.lg.logging("Total parameters:", total_parameters)
